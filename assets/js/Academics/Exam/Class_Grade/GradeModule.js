var GradeModule = function () {
    ...
    var ClassIdFld = $('#Form_Grade #class_id');
    var CodeFld = $('#Form_Grade #code');
    var NameFld = $('#Form_Grade #name');
    var SectionNameFld = $('#Form_Grade #section_name');

    var loader = $("#Form_Grade #loader");
    loader.hide();
    ...
    var loadGrid = function () {
        ...
        jQuery('#GradeGrid_wrapper .dataTables_filter input').addClass("form-control input-small"); // modify table search input
        jQuery('#GradeGrid_wrapper .dataTables_length select').addClass("form-control input-small"); // modify table per page dropdown
        jQuery('#GradeGrid_wrapper .dataTables_length select').select2(); // initialize select2 dropdown
    }

    // Edit record
    $('#GradeGrid').on( 'click', 'a.editView', function (e) {
        //alert('my edit'+id);

        var id = $(this).data('id');
        edit(id);
        $('#mdlCreateGrade .modal-title').html("Edit Class");
        $('#mdlCreateGrade').modal('show');
    });

    // Delete record
    $('#GradeGrid').on( 'click', 'a.deleteView', function (e) {
        var id = $(this).data('id');
    ...
    function ShowMessage(type, message){
        ...
        var error = $('#mdlCreateGrade .alert-danger');
        var success = $('#mdlCreateGrade .alert-success');
    ...
    function showPopup() {
        $('#Form_Grade').clearForm();// .trigger("reset");
        ClassIdFld.val("0");
        $('#mdlCreateGrade .modal-title').html("Create Grade");
        $('#mdlCreateGrade').modal('show');
    }
