var ExamModule = function () {
    ...
    var ClassIdFld = $('#Form_Exam #class_id');
    var CodeFld = $('#Form_Exam #code');
    var NameFld = $('#Form_Exam #name');
    var SectionNameFld = $('#Form_Exam #section_name');

    var loader = $("#Form_Exam #loader");
    loader.hide();
    ...
    var loadGrid = function () {
        ...
        jQuery('#ExamGrid_wrapper .dataTables_filter input').addClass("form-control input-small"); // modify table search input
        jQuery('#ExamGrid_wrapper .dataTables_length select').addClass("form-control input-small"); // modify table per page dropdown
        jQuery('#ExamGrid_wrapper .dataTables_length select').select2(); // initialize select2 dropdown
    }

    // Edit record
    $('#ExamGrid').on( 'click', 'a.editView', function (e) {
        //alert('my edit'+id);

        var id = $(this).data('id');
        edit(id);
        $('#mdlCreateExam .modal-title').html("Edit Class");
        $('#mdlCreateExam').modal('show');
    });

    // Delete record
    $('#ExamGrid').on( 'click', 'a.deleteView', function (e) {
        var id = $(this).data('id');
    ...
    function ShowMessage(type, message){
        ...
        var error = $('#mdlCreateExam .alert-danger');
        var success = $('#mdlCreateExam .alert-success');
    ...
    function showPopup() {
        $('#Form_Exam').clearForm();// .trigger("reset");
        ClassIdFld.val("0");
        $('#mdlCreateExam .modal-title').html("Create Exam");
        $('#mdlCreateExam').modal('show');
    }
