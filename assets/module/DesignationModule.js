var DesignationModule = function () {
    ...
    //Create Class
    var Designation = { DesignationId: 0, Code: '', Name: '', Description: '', Status: '' };
    ...
    var loadGridUrl = baseApiUrl + "Designation/List";
    var editUrl = baseApiUrl + "Designation/Find/";
    var saveUrl = baseApiUrl + "Designation/Save";
    var deleteUrl = baseApiUrl + "Designation/Delete/";
    var listUrl = baseAppUrl + "Employee/Designation";
    ...
    function save() {
        ...
        designation.DesignationId = DesignationIdFld.val();
        designation.Name = NameFld.val();
        designation.Description = DescriptionFld.val();
        designation.Status = StatusFld.val();
        ...
        $.ajax({
            ...
            complete: function (result) {
                ...
                if (obj.Success == true) {
                    window.location = listUrl + "?message=Designation Information Saved";
        ...
        var newTable = $('#example2').DataTable({
            ...
            columns: [
                ...
                { data: "Status" },
                {
                    data: null, render: function (data, type, row) {
                        ...
                        //return '<a href="Edit/' + data.DesignationId + '" class="btn btn-default btn-xs purple"><i class="fa fa-edit"></i> Edit</a>' +
                        //    '| <a href="#" class="btn btn-default btn-xs black"><i class="fa fa-trash-o"></i> Delete</a>';

                        //return '<a href="View/' + data.DesignationId + '" class="btn btn-default btn-xs purple"><i class="fa fa-eye"></i> View</a>' +
                        //        '| <a href="Edit/' + data.DesignationId + '" class="btn btn-default btn-xs purple"><i class="fa fa-edit"></i> Edit</a>';

                        return '<a href="#" class="btn btn-default btn-xs purple editView" data-id="' + data.DesignationId + '"><i class="fa fa-edit"></i> Edit</a>';
                    }
                },
            ...
            "fnInitComplete": function () {
                $(".editView").click(function () {
                    ...
                    $('#mdlCreateDesignation').modal('show');
                });
            }
        });
    ...
    //    $(".edit").attr("href", "../Edit/" + data.DesignationId);
    //};
    ...
    function showPopup() {
        $('#Form_Designation').trigger("reset");
        $('.modal-title').html("Create Designation");
        $('#mdlCreateDesignation').modal('show');
    }
