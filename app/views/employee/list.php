                ...
                <table id="EmployeeGrid" class="table table-striped table-bordered table-hover table-full-width">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <a href="
                          <?php echo base_url();?>/index.php/employee/edit/1">Noman Azeem
                        </a>
                      </td>
                      <td>Male</td>
                      <td>Computer</td>
                      ...
                      <td>
                        <a href="
                          <?php echo base_url();?>/index.php/employee/edit/1" class="btn btn-default btn-xs purple">
                          <i class="fa fa-edit"></i> Manage Employee
                        </a> |
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="
                          <?php echo base_url();?>/index.php/employee/edit/1">Arshad Iqbal
                        </a>
                      </td>
                      <td>Male</td>
                      <td>Computer</td>
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="
                          <?php echo base_url();?>/index.php/employee/edit/1">Salman Azeem
                        </a>
                      </td>
