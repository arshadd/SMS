        ...
        <div class="page-content">
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb breadcrumb">
                    ...
                    <li>
                        <a href="<?php echo site_url();?>/administration/hr/settings/index">HR Settings</a>
                        <i class="fa fa-angle-right"></i>
                    </li>
                    <li>
            ...
            <div class="alert alert-success display-hide">
                ...
                Designation Information saved successfully.
            </div>
                ...
                <div class="col-md-12">
                    <div class="portlet">
                        <div class="portlet-title">
                            ...
                            <div class="actions">
                                <a href="#" class="btn btn-primary" onclick="DesignationsModule.addView();">
                                    <i class="fa fa-pencil-square-o"></i> Add New Designation
                                </a>
                            </div>
                        </div>
                        <div class="portlet-body">
                            <table id="PositionGrid" class="table table-striped table-bordered table-hover table-full-width">
                                <thead>
                                <tr>
...
<div id="mdlCreateposition" class="modal fade" tabindex="-1" data-backdrop="static" data-keyboard="true" data-width="400">
    <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
        <h4 class="modal-title">Create Designation</h4>
    </div>
    <div class="modal-body">
        <?php include('_createOrEditDesignations.php');?>
    </div>
</div>
        ...
        <form class="form-horizontal" method="post">
            <div class="form-body">
              ...
              <span>
                ...
                <input type="hidden" id="employee_position_id" name="employee_position_id" class="form-control"/>
...
,'<script type="text/javascript" src="' . base_url() . 'assets/js/Administration/human_resources/settings/DesignationsModule.js" ></script>'
);

$pageJsCalls  = array(
    'DesignationsModule.init();'
);
