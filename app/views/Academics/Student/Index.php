				...
				<div class="col-md-12">
						<div class="portlet-body">
							<div class="form-body well">
								<div class="row">
									<div class="col-md-4">
										<h3><i class="fa fa-plus-circle icon-large"></i><a href="#">Student Admission</a></h3>
										<p>
											Student admission form.
										</p>
									</div>
									<div class="col-md-4">
										<h3><i class="fa fa-search icon-large"></i><a href="<?php echo base_url();?>index.php/academics/student/search">Student Search</a></h3>
										<p>
