                ...
                <div class="col-md-12">
                    <div class="portlet">
                        <div class="portlet-title">
                            ...
                            <div class="actions">
                                <a href="#" class="btn btn-success addNewSubject"  onclick="GradeModule.import();">
                                    <i class="fa fa-chevron-circle-down"></i> Import
                                </a>
                                <a href="#" class="btn btn-primary addNewSubject"  onclick="GradeModule.addView();">
                                    <i class="fa fa-pencil-square-o"></i> Add New Grade
                                </a>
                            </div>
                        </div>
                        <div class="portlet-body">
                            <table id="ExamGrid" class="table table-striped table-bordered table-hover table-full-width">
                                ...
                                <tr>
                                    ...
                                    <th class='hidden-xs'>Min Score (%)</th>
...
<div id="mdlCreateGrade" class="modal fade" tabindex="-1" data-backdrop="static" data-keyboard="true" data-width="500">
    <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
        <h4 class="modal-title">Create Exam</h4>
    </div>
    <div class="modal-body">
        <?php include('Create_edit_grade.php');?>
    </div>
</div>

<div id="mdlImport" class="modal fade" tabindex="-1" data-backdrop="static" data-keyboard="true" data-width="750">
    <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
        <h4 class="modal-title"><i class="fa fa-chevron-circle-down"></i> Import Grade</h4>
    </div>
    <div class="modal-body">
        <?php include('Import_Grade.php');?>
    </div>
</div>

<div id="mdlDeleteGrade" class="modal fade" tabindex="-1" data-backdrop="static" data-keyboard="true" data-width="400">
    <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
...
$pageJsScript  = array(
    ...
    ,    '<script type="text/javascript" src="' . base_url() . 'assets/js/Academics/Exam/Class_Grade/GradeModule.js" ></script>'
