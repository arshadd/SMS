                ...
                <div class="col-md-12">
                    <div class="portlet">
                        <div class="portlet-title">
                            ...
                            <div class="actions">
                                <a href="#" class="btn btn-success addNewSubject"  onclick="ExamModule.import();">
...
<div id="mdlImport" class="modal fade" tabindex="-1" data-backdrop="static" data-keyboard="true" data-width="750">
    <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
        <h4 class="modal-title"><i class="fa fa-chevron-circle-down"></i> Import Exam</h4>
    </div>
    <div class="modal-body">
        <?php include('Import_Exam.php');?>
    </div>
</div>
...
$pageJsScript  = array(
    ...
    ,    '<script type="text/javascript" src="' . base_url() . 'assets/js/Academics/Exam/Class_Exam/ExamModule.js" ></script>'
