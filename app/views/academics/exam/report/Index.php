								...
								<div class="row">
									<div class="col-md-4">
										<h3 class="page-title"><i class="fa fa-file-text icon-large"></i>
											<a href="<?php echo site_url();?>/academics/exam/report/class_exam">Class Exam Report</a>
										</h3>
										<p>
											Print class exam result report.
										</p>
									</div>
									<div class="col-md-4">
										<h3 class="page-title"><i class="fa fa-file-text icon-large"></i>
											<a href="<?php echo site_url();?>/academics/exam/report/student_exam">Student Exam Report</a>
										</h3>
										<p>
											Print student's exam result report.
										</p>
									</div>
									<!--<div class="col-md-4">
										<h3 class="page-title"><i class="fa fa-file-text icon-large"></i>
