...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
				<i class="fa fa-calendar icon-large"></i>
				Timetable
			</h3>
			<div class="page-bar">
								...
								<div class="row">
									...
									<div class="col-md-4">
										<h3 class="page-title"><i class="fa fa-shield icon-large"></i>
											<a href="<?php echo site_url();?>/academics/timetable/manage/class_timetable">Class / Batch Timetable</a></h3>
										<p>
											Manage Class / Batch Timetable.
										</p>
									</div>
									<div class="col-md-4">
										<h3 class="page-title"><i class="fa fa-group icon-large"></i>
											<a href="<?php echo site_url();?>/academics/timetable/manage/employee_timetable">Employee's Timetable</a></h3>
										<p>
											Manage Employee's Timetable.
										</p>
									</div>
								</div>
